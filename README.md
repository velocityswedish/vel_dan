# 🇩🇰 Velocity Danish - Automated Facebook Reels Bot

**Automated Danish learning content generator for social media**

Generates and posts 4x daily to Facebook, Instagram, and other platforms with:
- ✅ AI-generated Danish phrases with English translations
- ✅ Professional text-to-speech (Edge TTS)
- ✅ Beautiful gradient backgrounds with text overlays
- ✅ Perfect audio-video synchronization
- ✅ Velocity Danish branding
...
4. Wisdom (Visdom)
5. Happiness (Lykke)
6. Self Improvement (Selvudvikling)
7. Gratitude (Taknemmelighed)
8. Friendship (Venskab)
9. Hope (Håb)
10. Creativity (Kreativitet)
11. Inner Peace (Indre Ro)
12. Confidence (Selvtillid)
13. Perseverance (Udholdenhed)
14. Inspiration (Inspiration)
15. Positive Life (Positivt Liv)
16. Courage (Mod)
17. Kindness (Venlighed)
18. Patience (Tålmodighed)
...
1. Go to Actions → "Velocity Danish - Daily 4x Upload"
...
- **Frame Rate:** 30 FPS
- **Audio:** Edge TTS (GuyNeural EN, ChristelNeural DA)
...
- English + 500ms pause + Danish timing preserved
...
- Distinct colors: Navy (EN) / Maroon (DA) / Gray (Pronunciation)
- Velocity Danish branding on every frame
...
**Made with ❤️ for Danish learners worldwide**

🇩🇰 Lær Dansk med Velocity Danish! 🇩🇰
